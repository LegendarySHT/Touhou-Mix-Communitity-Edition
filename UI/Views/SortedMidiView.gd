...
## 当前排序字段
var current_sort_field: int = SortingEngine.SortField.DOWNLOAD_COUNT

## 当前排序方向
var current_sort_direction: int = SortingEngine.SortDirection.DESCENDING

## 当前状态过滤
var current_status_filter: String = "APPROVED"
...
func _load_sorted_midis() -> void:
	...
	# 应用过滤和排序
	current_midis = sorting_engine.filter_and_sort(
		all_midis,
